...
def main():
    audio_path = r"D:\AI\Template Voice\Review 2.mp3"
    text_path = r"D:\AI\Template Voice\Review 2.txt"
    standalone_json_path = r"D:\AI\Template Voice\Review 2_preset.json"
    ...
    tts.add_voice(
        ...
        description="Review 2 · Trợ lý AI / Tự nhiên",
        gender="male",
        save=True
    )
    print("Added Review 2 to voices_v3_turbo.json successfully.")

    # Also export standalone preset JSON file in Template Voice directory
    voice_data = tts.get_preset_voice("Review 2")
    export_dict = {
        "name": "Review 2",
        "description": "Review 2 · Trợ lý AI / Tự nhiên",
        "gender": "male",
    ...
    print("Testing inference with Review 2...")
    wav = tts.infer("Thử nghiệm chất giọng Review 2 đã sẵn sàng hoạt động!", voice="Review 2")
    print(f"Inference successful: generated {len(wav)} samples.")
